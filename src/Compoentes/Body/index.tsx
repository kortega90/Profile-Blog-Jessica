              ...
              <div className="text-center text-xxl-start">
                <div className="badge bg-gradient-primary-to-secondary text-white mb-4">
                  <div className="text-uppercase">
                    Paralegal&middot; Declaração Imposto de Renda &middot; 
                    <br />
                    Abertura, Alteração e Encerramento de Empresas&middot; 
                ...
                <h1 className="display-3 fw-bolder mb-5">
                  <span className="text-gradient d-inline">
                    Visualiza meu portfólio profissional e serviços
                  </span>
                </h1>
                ...
                <div className="profile bg-gradient-primary-to-secondary">
                  ...
                  <div className="dots-1">
                    ...
                    <svg
                      ...
                      enableBackground="enable-background: new 0 0 191.6 1215.4"
                      xmlSpace="preserve"
                    >
                    ...
                    <div className="row gx-5 justify-content-center">
                        <div className="col-xxl-8">
                            <div className="text-center my-5">
                                <h2 className="display-5 fw-bolder"><span className="text-gradient d-inline">SOBRE NÓS</span></h2>
                                <p className="lead fw-light mb-4">Meu nome é Jessica e possuo um sistema de contabilidade online</p>
